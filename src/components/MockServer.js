...
export default function MockServer() {
  ...
  return (
    ...
    <Box sx={{ width: '100%', margin: 'auto', p: 3, pt: 0, display: 'flex', justifyContent: 'center', flexDirection: { xs: 'column', md: 'row' }, gap: 0, border: 1, borderColor: 'divider', boxShadow: 1 }}>
      <Box sx={{ display: 'flex', width: '50%', flexDirection: 'column', gap: 2, p: 3 }}>
